...
for i in ListOfTemperatureToPredict:
    ...
    predicted_DF_linearReg_split_pred=predicted_DF_linearReg_split["2016-04-01":"2016-05-01"]
    ...
    predicted_DF_linearReg_CV_prd=predicted_DF_linearReg_CV["2016-04-01":"2016-05-01"]
